...
export const ProjectConfigStep = ({ onNext }: ProjectConfigStepProps) => {
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="ej. App Móvil de Fintech"
            className="text-lg"
          />
        </div>
        ...
        <div className="space-y-2">
          <Label htmlFor="framework">Framework UX*</Label>
          <Select value={selectedFramework} onValueChange={setSelectedFramework}>
            <SelectTrigger>
              <SelectValue placeholder="Selecciona un framework UX" />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="flex justify-end pt-4">
          <Button 
            onClick={handleNext}
            disabled={!projectName.trim() || !selectedFramework}
            className="gap-2"
          >
